<aside class="mt-10">
    <nav>
        <a href="<?=$base?>/">
            <div class="menu-item <?=($active_menu == 'home')? 'active':''?>">
        ...
        <a href="<?=$base?>/profile">
            <div class="menu-item <?=($active_menu == 'profile')? 'active':''?>">
                <div class="menu-item-icon">
        ...
        <a href="<?=$base?>/friends">
            <div class="menu-item <?=($active_menu == 'friends')? 'active':''?>">
                <div class="menu-item-icon">
        ...
        <a href="<?=$base?>/photos">
            <div class="menu-item <?=($active_menu == 'fotos')? 'active':''?>">
                <div class="menu-item-icon">
        ...
        <a href="<?=$base?>/config">
            <div class="menu-item <?=($active_menu == 'config')? 'active':''?>">
                <div class="menu-item-icon">
